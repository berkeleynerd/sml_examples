...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_schema_loader" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a61a19d4#;
   pragma Export (C, u00001, "test_schema_loaderB");
